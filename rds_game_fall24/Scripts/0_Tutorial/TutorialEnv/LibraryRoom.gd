...
func _ready():
	...
	var actorF = get_node("characters/student_npc6")
	var actorG = get_node("characters/student_npc7")
	var actorH = get_node("characters/student_npc8")
	...
	match (PS.library_state):
		0:
			...
			var actionA = Action.new(actorA, "LerpMove", actorA.position - Vector2(2624,0), 200)
			var actionB = Action.new(actorB, "LerpMove", actorB.position - Vector2(2624,0), 200)
			var actionC = Action.new(actorC, "LerpMove", actorC.position - Vector2(2624,0), 200)
			var actionD = Action.new(actorD, "LerpMove", actorD.position - Vector2(2624,0), 200)
			var actionE = Action.new(actorE, "LerpMove", actorE.position - Vector2(2624,0), 200)
			var actionF = Action.new(actorF, "LerpMove", actorF.position - Vector2(2624,0), 200)
			var actionG = Action.new(actorG, "LerpMove", actorG.position - Vector2(2624,0), 200)
			var actionH = Action.new(actorH, "LerpMove", actorH.position - Vector2(2624,0), 200)
			var actionP = Action.new(player, "LerpMove", player.position - Vector2(2624,0), 200)
			
			var actions : Array[Action] = [actionA, actionB, actionC, actionD, actionE, actionF, actionG, actionH, actionP]
			...
			var action_malvoren_entrance = Action.new(malvoren, "LerpMove", malvoren.position + Vector2(576,0,),200)
			...
			var actionCam = Action.new(player_cam, "LerpMove", Vector2(256, -640), 300)
			...
			#refix camera to see student tour group
			actionCam = Action.new(player_cam, "LerpMove", player.global_position / 1000., 300)
			actions = [actionCam]
			for action in actions:
				add_child(action)
			...
			actionA = Action.new(actorA, "LerpMove", actorA.position + Vector2(2748,0), 200)
			actionB = Action.new(actorB, "LerpMove", actorB.position + Vector2(2748,0), 200)
			actionC = Action.new(actorC, "LerpMove", actorC.position + Vector2(2748,0), 200)
			actionD = Action.new(actorD, "LerpMove", actorD.position + Vector2(2748,0), 200)
			actionE = Action.new(actorE, "LerpMove", actorE.position + Vector2(2748,0), 200)
			actionF = Action.new(actorF, "LerpMove", actorF.position + Vector2(2748,0), 200)
			actionG = Action.new(actorG, "LerpMove", actorG.position + Vector2(2748,0), 200)
			actionH = Action.new(actorH, "LerpMove", actorH.position + Vector2(2748,0), 200)
			var actionTW = Action.new(thornewood, "LerpMove", thornewood.position + Vector2(2748,0), 225)
			actions = [actionA, actionB, actionC, actionD, actionE, actionF, actionG, actionH, actionTW]
			for action in actions:
				add_child(action)
			...
			var actionPa = Action.new(player, "LerpMove", Vector2(1472, -320), 200)
			var actionPb = Action.new(player, "LerpMove", Vector2(1472, -832), 200)
			actionCam = Action.new(player_cam, "LerpMove", player.position / 1000., 225)
