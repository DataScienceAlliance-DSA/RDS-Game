...
func _ready():
	...
	left_pan_rotate = get_node("LeftPanRotate")
	left_pan = get_node("LeftPanRotate/Left_Pan")
	right_pan_rotate = get_node("RightPanRotate")
	right_pan = get_node("RightPanRotate/RightPan")
