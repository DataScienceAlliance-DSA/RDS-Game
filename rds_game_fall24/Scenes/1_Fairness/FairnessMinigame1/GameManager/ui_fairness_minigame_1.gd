...
@onready var max_villagers : int = 7 # total # of villagers that can be on screen at a time
...
func _on_timer_timeout():
	...
	UI.get_node("Monologue").open_3choice_dialogue("res://Resources/Texts/Monologues/1_Fairness/FairnessMinigame1/FoxFairness1Failure.json", null)
	await UI.get_node("Monologue").closed_signal
